...
```{r logo, echo=FALSE, out.width = '50%', fig.align = "center", fig.cap="Fig 1 : Disponible à l'adresse https://www.global.surgery/fr/actualites/chirurgie-medecine-esthetique/biohacking-lausanne"}
...
```{r logo2, echo=FALSE, out.width = '30%', fig.align = "center", fig.cap="Fig 2 : Disponible à l'adresse https://www.samsung.com/fr/apps/samsung-health/"}
...
```{r logo3, echo=FALSE, out.width = '30%', fig.align = "right", fig.cap="Fig 3 : Disponible à l'adresse https://www.radiofrance.fr/franceculture/podcasts/hashtag/je-me-sens-en-insecurite-sans-mon-telephone-4782332"}
...
```{r logo4, echo=FALSE, out.width = '30%', fig.align = "right", fig.cap="Fig 4 : Disponible à l'adresse https://commentjaichangedevie.fr/tu-veux-ou-tu-veux-pas/"}
...
```{r logo5, echo=FALSE, out.width = '30%', fig.align = "center", fig.cap="Fig 5 : Disponible à l'adresse https://www.gamekyo.com/group_article57080.html"}
knitr::include_graphics("Akira.png")
```
